...
function MorrisDashboard(){
	Morris.Line({
		...
		data: [
			...
			{"period": "2013-12", "Win8": 80, "Win7": 55.9, 'Vista': 1.5, 'NT': 3.1, 'XP':11.6, 'Linux': 4.8, 'Mac': 9.2 , 'Mobile':3.8},
			...
			{"period": "2013-06", "Win8": 30.6, "Win7": 56.3, 'Vista': 2, 'NT': 0.4, 'XP':15.4, 'Linux': 4.9, 'Mac': 9.1 , 'Mobile':3.2},
			...
			{"period": "2013-01", "Win8": 49.8, "Win7": 55.3, 'Vista': 2.6, 'NT': 0.5, 'XP':19.9, 'Linux': 4.8, 'Mac': 9.3 , 'Mobile':2.2}
		],
		xkey: 'period',
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		ajax_url = '/Projet/web/app_dev.php/admin/produit/ajax';
	}
